...
define('OAUTH_REDIRECT_URI', 'https://vbgnn-110-139-174-5.a.free.pinggy.link/nuansa/callback.php');
...
define('ACCURATE_ACCESS_TOKEN', '974efae2-f1ed-4977-97ba-9238b7131ddf');
define('ACCURATE_TOKEN_SCOPE', 'unit_save branch_view unit_delete fixed_asset_view tax_view item_transfer_view access_privilege_view employee_view journal_voucher_view sales_order_save glaccount_view purchase_invoice_view item_category_view sales_invoice_view warehouse_view sellingprice_adjustment_view stock_mutation_history_view unit_view customer_view vendor_category_view sales_order_view sales_receipt_view payment_term_view shipment_view item_transfer_save purchase_order_view sellingprice_adjustment_save item_view vendor_view sales_invoice_save item_save price_category_view');
define('ACCURATE_REFRESH_TOKEN', '62473b92-8265-490b-a713-44b832abac10');
