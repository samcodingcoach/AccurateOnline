...
// Gunakan gl account detail API
$result = $api->getGlAccountDetail($accountId);
$account = null;
$rawResponse = $result; // Simpan raw response dari detail

if ($result['success'] && isset($result['data']['d'])) {
    $account = $result['data']['d'];
}
...
<head>
    ...
    <title>Detail Akun GL - Nuansa</title>
        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900">Detail Akun Perkiraan</h1>
                </div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-gray-900">Detail Akun</h2>
                    </div>
                </div>
                ...
                <div class="p-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo htmlspecialchars($account['no'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo htmlspecialchars($account['name'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo htmlspecialchars($account['id'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                             <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo htmlspecialchars($account['lvl'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                           <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo htmlspecialchars($account['accountTypeName'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo htmlspecialchars($account['asOf'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                             <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900"><?php echo number_format($account['openBalance'] ?? 0, 0, ',', '.'); ?></span>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                    <i class="fas fa-dollar-sign text-gray-400 mr-3"></i>
                                    <span class="text-gray-900"><?php echo number_format($account['balance'] ?? 0, 0, ',', '.'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Child Accounts -->
                    <?php if (!empty($account['childList'])): ?>
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Anak Akun</h3>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No</th>
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No. COA</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php foreach ($account['childList'] as $index => $child): ?>
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $index + 1; ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($child['no'] ?? 'N/A'); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($child['id'] ?? 'N/A'); ?></td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo htmlspecialchars($child['name'] ?? 'N/A'); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="mx-6 mb-6 bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="text-sm">
                        <p><strong>Data Source:</strong> GL Account Detail API (/detail.do)</p>
                        <p><strong>Detail API Success:</strong> <?php echo isset($result) && $result['success'] ? 'Yes' : 'No'; ?></p>
                        <p><strong>Account Found:</strong> <?php echo $account ? 'Yes' : 'No'; ?></p>
        ...
        <?php else: ?>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-center">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 mb-2">Akun GL Tidak Ditemukan</h2>
                    <p class="text-gray-600 mb-4">Akun GL dengan ID <?php echo htmlspecialchars($accountId); ?> tidak ditemukan.</p>
                    <?php if (isset($result['error'])): ?>
                        <p class="text-red-600 mb-4"><?php echo htmlspecialchars($result['error']); ?></p>
                    <?php endif; ?>
                    <a href="index.php" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">
                        Kembali ke Daftar Akun GL
                    </a>
                </div>
            </div>
        <?php endif; ?>
